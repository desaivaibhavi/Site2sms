...
#
# Script to send SMS via Site2sms
#
# @author Yash Shah
# @license BSD License
# 
...
# To fool Site2sms as if a Web browser is visiting the site
...
#Remember, Cookies are to be handled
  ...
  Login_status = 'Logout' in the_page
...
#def sendMessage(number='',message=''):
  while True:
    ...
    send_sms_data = urllib.urlencode({'txtCategory':'40',
				      'txtGroup':'0',
				      'txtMessage': message,
				      'txtMobileNo': number,
				      'txtUsed':len(message)})
